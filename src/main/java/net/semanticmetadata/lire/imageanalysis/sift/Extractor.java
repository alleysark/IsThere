...
public class Extractor {
    ...
    private void align(BufferedImage img1, BufferedImage img2) {
        try {
            ...
            System.out.println("fs2.size = " + fs2.size());
            ...
            ImageIO.write(img1, "jpg", new File("c:/dropbox/out1.jpg"));
            ImageIO.write(img2, "jpg", new File("c:/dropbox/out2.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
//        BufferedImage img = ImageIO.read(new File("test.jpg"));
    ...
    public static void main(String[] args) throws IOException {
        ...
        e.align(ImageIO.read(new File("c:/dropbox/test1.jpg")), ImageIO.read(new File("c:/dropbox/test2.jpg")));
    }
