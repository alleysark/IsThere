...
public class DocumentBuilderFactory {
    ...
    /**
     * Creates a DocumentBuilder include SIFT algorithm
     *
     * @return a fully featured DocumentBuilder.
     */
    public static DocumentBuilder getExtensiveDocumentBuilderWithSIFT() {
        ChainedDocumentBuilder chainedDocumentBuilder = new ChainedDocumentBuilder();
        chainedDocumentBuilder.addBuilder(DocumentBuilderFactory.getCEDDDocumentBuilder());
        chainedDocumentBuilder.addBuilder(DocumentBuilderFactory.getFCTHDocumentBuilder());
        chainedDocumentBuilder.addBuilder(DocumentBuilderFactory.getJCDDocumentBuilder());

        chainedDocumentBuilder.addBuilder(DocumentBuilderFactory.getColorLayoutBuilder());
        chainedDocumentBuilder.addBuilder(DocumentBuilderFactory.getScalableColorBuilder());
        chainedDocumentBuilder.addBuilder(DocumentBuilderFactory.getEdgeHistogramBuilder());
...
//        chainedDocumentBuilder.addBuilder(DocumentBuilderFactory.getS);
     ...
     * @return a fully featured DocumentBuilder.
     */
    public static DocumentBuilder getIsThereDocumentBuilder() {
        ChainedDocumentBuilder chainedDocumentBuilder = new ChainedDocumentBuilder();
//        chainedDocumentBuilder.addBuilder(DocumentBuilderFactory.getCEDDDocumentBuilder());
//        chainedDocumentBuilder.addBuilder(DocumentBuilderFactory.getFCTHDocumentBuilder());
        chainedDocumentBuilder.addBuilder(DocumentBuilderFactory.getJCDDocumentBuilder());
...
//        return new GenericFastDocumentBuilder(ScalableColor.class, DocumentBuilder.FIELD_NAME_SCALABLECOLOR);
    ...
    public static DocumentBuilder getAutoColorCorrelogramDocumentBuilder() {
        return new GenericDocumentBuilder(AutoColorCorrelogram.class, DocumentBuilder.FIELD_NAME_AUTOCOLORCORRELOGRAM);
...
//        return new GenericDocumentBuilder(JpegCoefficientHistogram.class, DocumentBuilder.FIELD_NAME_JPEGCOEFFS, GenericDocumentBuilder.Mode.Fast);
        return new GenericDocumentBuilder(JpegCoefficientHistogram.class, DocumentBuilder.FIELD_NAME_JPEGCOEFFS);
    }
...
//        return new GenericFastDocumentBuilder(Gabor.class, DocumentBuilder.FIELD_NAME_GABOR);
    ...
    /**
     * Creates a DocumentBuilder for SIFT feature.
     *
     * @return the created SIFT feature DocumentBuilder.
     */
    public static DocumentBuilder getSIFTDocumentBuilder() {
        //return new GenericDocumentBuilder(SIFT.class);
        return null;
    }
