...
//        IndexWriter indexWriter = LuceneUtils.createIndexWriter(indexPath, false); //기존 인덱스 사용
        IndexWriter indexWriter = LuceneUtils.createIndexWriter(indexPath, true); //새로 만들기
